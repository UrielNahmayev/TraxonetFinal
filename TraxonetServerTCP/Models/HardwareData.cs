...
namespace TraxonetServer_TCP.Models
{
    public class HardwareData
    {
        ...
        [JsonProperty("drives")] public List<DriveData> Drives { get; set; }
        [JsonProperty("authorizedEmails")] public List<string> AuthorizedEmails { get; set; }
        [JsonProperty("alertEmails")] public List<string> AlertEmails { get; set; }
